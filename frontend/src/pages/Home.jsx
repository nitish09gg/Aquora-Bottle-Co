  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F7FCFF] text-slate-900">
      ...
      <header className="relative z-10">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/signup"
              className="rounded-full bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-sky-200 transition hover:bg-sky-700"
            >
              Request Mockup
            </Link>
          </div>
      ...
      <main className="relative z-10">
        <section className="mx-auto grid max-w-7xl items-center gap-14 px-6 pb-20 pt-16 lg:grid-cols-2 lg:px-8 lg:pb-28 lg:pt-24">
          <div>
